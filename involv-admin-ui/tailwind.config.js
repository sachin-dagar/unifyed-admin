module.exports = {
  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        aboutUsDesktop: "url('./assets/images/images/About-desktop/about-us-banner-bg.png')",
        ...
        resourcesBgBanner: "url('./assets/images/images/Resource-Desktop/banner-bg-resources.png')",
        notificationResourcesBg: "url('./assets/images/images/Resource-Desktop/notification-bg-resources.png')",
        newsBgResourcesUi: "url('./assets/images/images/Resource-Desktop/news-bg-resource-ui.png')",
        resourcesBanneriPad: "url('./assets/images/images/Resources-iPad/ResoureBannerBg-iPad.png')",
        resourceBannerMobile: "url('./assets/images/images/Resource-mobile/bgBanner-mobile-resource.png')",
        whatMakeDifferentBg: "url('./assets/images/images/About-desktop/what-make-us-different-bg.png')",
        bannerAboutIpad: "url('./assets/images/images/about-us-ipad/banner-bg-about.png')",
        whatMakeDifferentBgIpad: "url('./assets/images/images/about-us-ipad/what-make-different-bg-ipad.png')",
        bannerAboutMobile: "url('./assets/images/images/about-us-mobile/banner-about-us-mobile.png')",
        whatMakeDifferentMobile: "url('./assets/images/images/about-us-mobile/what-make-us-different-mobile.png')",
        trustCentreBannerBg: "url('./assets/images/images/trust-centre-desktop/trust-centre-banner-bg.png')",
        trustCentreBannerBgiPad: "url('./assets/images/images/trust-centre-iPad/trust-centre-banner-bg-iPad.png')",
        trustCentreBannerBgMobile:
          "url('./assets/images/images/trust-centre-mobile/trust-centre-banner-bg-mobile.PNG')",
      },
      screens: {
        "3xl": "1900px",
        sl: "1366px",
  ...
  plugins: [require("tailwind-scrollbar"), require("@tailwindcss/forms"), require("tailwindcss-pseudo-elements")],
};
