...
const ResetPassword = ({ handleloginnow }) => {
  ...
  useEffect(() => {
    ...
    if (!localStorage.getItem("forgotValidation")) navigate("/forgot-password");
  }, []);
      ...
      if (password !== cpassword) {
        ...
        try {
          ...
          const data = {
            ...
            token: JSON.parse(localStorage.getItem("forgotValidation")),
            password,
          };
          const response = await apiProvider.post(
            "api/user/forgotpassword/confirm",
            data
          );
